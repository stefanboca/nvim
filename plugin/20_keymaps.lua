...
nmap("grn", '<Cmd>lua require("live-rename").rename()<CR>', "Rename (lsp)")
nmap("g.", '<Cmd>lua require("tiny-code-action").code_action()<CR>', "Code actions (lsp)")
nmap("gA", "<Cmd>Trouble lsp_references<CR>", "References (lsp)")
nmap("gD", "<Cmd>Trouble lsp_declarations<CR>", "Declaration (lsp)")
nmap("gI", "<Cmd>Trouble lsp_implementations<CR>", "Implementation (lsp)")
nmap("gY", "<Cmd>Trouble lsp_type_definitions<CR>", "Type definition (lsp)")
nmap("gd", "<Cmd>Trouble lsp_definitions<CR>", "Definition (lsp)")
