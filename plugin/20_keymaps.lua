...
nmap("g.", '<Cmd>lua require("tiny-code-action").code_action()<CR>', "Actions")
nmap("gA", "<Cmd>Trouble lsp_references<CR>", "References (lsp)")
nmap("gD", "<Cmd>Trouble lsp_declarations<CR>", "Declaration")
...
nmap("gd", "<Cmd>Trouble lsp_definitions<CR>", "Source definition (lsp)")
