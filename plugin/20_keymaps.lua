...
nmap_leader(".", toggle_scratch, "Scratch toggle")
nmap_leader("ba", "<Cmd>b#<CR>", "Alternate")
nmap_leader("bd", "<Cmd>lua MiniBufremove.delete()<CR>", "Delete")
nmap_leader("bD", "<Cmd>lua MiniBufremove.delete(0, true)<CR>", "Delete!")
nmap_leader("bs", toggle_scratch, "Scratch toggle")
...
nmap_leader("li", "<Cmd>lua vim.lsp.buf.implementation()<CR>", "Implementation (lsp)")
...
nmap_leader("ls", "<Cmd>lua vim.lsp.buf.definition()<CR>", "Source definition (lsp)")
nmap_leader("lt", "<Cmd>lua vim.lsp.buf.type_definition()<CR>", "Type definition (lsp)")
...
nmap_leader("oH", inlay_hint_toggle, "Inlay Hint toggle")
nmap_leader("oT", treesitter_toggle, "Treesitter toggle")
nmap_leader("of", autoformat_toggle(false), "Autoformat toggle (buf)")
nmap_leader("oF", autoformat_toggle(true), "Autoformat toggle")
...
nmap_leader("ts", '<Cmd>lua require("neotest").summary.toggle()<CR>', "Summary toggle")
